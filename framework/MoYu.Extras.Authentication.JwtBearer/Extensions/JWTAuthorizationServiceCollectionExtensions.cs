...
public static class JWTAuthorizationServiceCollectionExtensions
{
    ...
    {
        // 植入 MoYu | 规范化接口框架
        var MoYuAssembly = JWTEncryption.GetFrameworkContext(Assembly.GetCallingAssembly());

        // 获取添加授权类型
        var authorizationServiceCollectionExtensionsType = MoYuAssembly.GetType("Microsoft.Extensions.DependencyInjection.AuthorizationServiceCollectionExtensions");
