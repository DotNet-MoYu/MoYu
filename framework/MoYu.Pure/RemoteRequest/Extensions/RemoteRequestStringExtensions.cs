...
namespace MoYu.RemoteRequest.Extensions;
...
public static class RemoteRequestStringExtensions
{
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static Task<(Stream Stream, Encoding Encoding, HttpResponseMessage Response)> GetAsStreamAsync(this string requestUrl, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static Task<(Stream Stream, Encoding Encoding, HttpResponseMessage Response)> PostAsStreamAsync(this string requestUrl, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static Task<(Stream Stream, Encoding Encoding, HttpResponseMessage Response)> PutAsStreamAsync(this string requestUrl, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static Task<(Stream Stream, Encoding Encoding, HttpResponseMessage Response)> DeleteAsStreamAsync(this string requestUrl, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static Task<(Stream Stream, Encoding Encoding, HttpResponseMessage Response)> PatchAsStreamAsync(this string requestUrl, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static Task<(Stream Stream, Encoding Encoding, HttpResponseMessage Response)> HeadAsStreamAsync(this string requestUrl, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    public static Task<(Stream Stream, Encoding Encoding, HttpResponseMessage Response)> SendAsStreamAsync(this string requestUrl, CancellationToken cancellationToken = default)
    {
