...
internal class Program
{
    ...
    private static void HelpHandler(ArgumentMetadata argument) => Cli.GetHelpText("MoYu");
    ...
    private static void FrameworkHandler(ArgumentMetadata argument) => Cli.WriteLine(Cli.ReadOptions("请选择您最喜欢的框架：", new[] { "MoYu", "Abp Next", "ASP.NET Core" }));
