**中** | [En](https://github.com/MonkSoul/MoYu)
...
[MoYu](https://gitee.com/dotnetchina/MoYu) 主要根据 MIT 许可证和 Apache 许可证（版本 2.0）。

有关详细信息，请参阅 [LICENSE-APACHE](https://gitee.com/dotnetchina/MoYu/blob/v4/LICENSE-APACHE)、[LICENSE-MIT](https://gitee.com/dotnetchina/MoYu/blob/v4/LICENSE-MIT) 和 [COPYRIGHT](https://gitee.com/dotnetchina/MoYu/blob/v4/COPYRIGHT)。