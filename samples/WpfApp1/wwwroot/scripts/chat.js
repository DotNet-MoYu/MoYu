...
document.getElementById("send").addEventListener("click", function (event) {
    var user = document.getElementById("myname").value || "MoYu";
...
function addMsg(user, message) {
    var yourName = document.getElementById("myname").value || "MoYu";
    ...
    div.classList.add("MoYu-messages-item");
    if (isSender == true) div.classList.add("send");

    div.innerHTML = `<div class="MoYu-messages-picture" style="${isSender ? "background:#ff006e;" : ""}">${pic}</div>
                    <div class="MoYu-message-content">
                        <div class="MoYu-messages-label">${user}</div>
                        <div class="MoYu-messages-msg">${msg}</div>
                    </div>`;
...
function addSysMsg(message) {
    var div = document.createElement("div");
    div.classList.add("MoYu-system-msg");
